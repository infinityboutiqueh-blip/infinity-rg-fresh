...
export default function InfinityRGSite() {
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      {/* HEADER */}
      <header className="bg-slate-950 text-white px-6 py-4 flex items-center justify-between shadow-md relative">
        {/* Logo */}
        ...
        <a
          href="#contact"
          className="hidden md:inline bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg text-sm font-medium"
        >
          Get in touch →
        </a>
        ...
        <div
          id="mobile-menu"
          className="hidden absolute top-16 right-6 bg-slate-900 border border-slate-700 rounded-lg shadow-md p-4 flex flex-col space-y-3 md:hidden z-50"
        >
          <NavLink href="#services">Services</NavLink>
          <NavLink href="#whyus">Why Us</NavLink>
          <NavLink href="#process">Process</NavLink>
          ...
          <a
            href="#contact"
            className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg text-sm font-medium text-center"
          >
            Get in touch →
          </a>
        </div>
      ...
      <Section id="about" className="py-12">
        <div className="mb-8">
          ...
          <p className="text-slate-400 mt-2 max-w-3xl">
            ...
            active in the UK and Italy, and open to opportunities further afield
