    ...
    <div className='sticky top-0 z-40 border-b border-slate-200 bg-white/80 backdrop-blur'>
      <div className='mx-auto flex max-w-6xl items-center justify-between px-4 py-3'>
        <div className='flex items-center gap-3'>
          ...
          <img src='/infinityrg-logo.png' alt='Infinity RG logo' className='h-24 w-auto' />
        ...
        <div className='hidden items-center gap-6 md:flex'>
          ...
          <a href='#why' className='text-sm font-semibold text-slate-600 hover:text-slate-900'>
            Why Us
          </a>
  ...
  return (
    <div className='relative overflow-hidden bg-slate-50'>
      ...
      <div className='relative mx-auto grid max-w-6xl grid-cols-1 gap-10 px-4 py-12 md:grid-cols-2 md:items-center md:py-16'>
        ...
        {/* VIDEO AREA (replaces Quick Snapshot in hero) */}
        <Card className='p-3'>
          <div className='overflow-hidden rounded-2xl border border-slate-200 bg-white'>
            <div className='aspect-video w-full bg-slate-100'>
              {/* Self-hosted video:
                  Put file here: /public/intro.mp4
                  Optional poster: /public/intro-poster.jpg
              */}
              <video
                ...
                playsInline
                preload='metadata'
                // Hides the download button in most Chromium browsers (not a security feature)
...
function About() {
  return (
    <Section id='about' alt title='About Infinity RG' subtitle='We’re focused on practical results and long-term partnerships.'>
      <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
        <Card className='p-6'>
